    ...
    while (not gridFull(grid.grid)):
        ...
        if (playerTurn == p2):
            ...
            # if player2 written in JAVA
                ...
                tic = time.time()
                move = playerTurn.get_move(
                    java_board, playerTurn.get_symbole())
                x, y = move[0], move[1]
                toc = time.time()
                # Check if the cell is available
            ...
            gui.writeScreen_4_show(
                screen, "[P1(Green)]:"+str(p1.get_score())+"    [P2(Red)]:"+str(p2.get_score()), line=4)
            print("Current score for player1 (green), player2 (red):",
        ...
        # if the player is player1
            ...
            print("Current score for player1 (green), player2 (red):",
                  p1.get_score(), p2.get_score())
            gui.writeScreen_4_show(
                screen, "[P1(Black)]:"+str(p1.get_score())+"    [P2(Red)]:"+str(p2.get_score()), line=4)
